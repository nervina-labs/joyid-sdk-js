...
import { createApplePass, parseSerialNumber, servePass } from '../../../src/passkit'
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    if (req.method === 'POST') {
        ...
        try {
            ...
            const { ethAddress, cardId, campaign } = parseSerialNumber(serialNumber as string, passDetails.campaign)
